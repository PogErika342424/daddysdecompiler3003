...
local function synsaveinstance(CustomOptions, CustomOptions2)
	...
	local OPTIONS = {
		...
		--MaxThreads = 5 -- Description: The number of decompilation threads that can run at once. More threads means it can decompile for scripts at a time.
									...
									elseif "ProtectedString" == ValueType then -- TODO: Try fitting this inside Descriptors
										...
										if PropertyName == "Source" then
											if DecompileIgnoring then -- ? Should this really prevent extraction of the original source if present ?
												...
												value = "-- Thanks for using our Decompiles Service https://discord.gg/J9KpDA8kHT\n\n"
	...
	local function save_game()
		...
		savebuffer[savebuffer_size] =
			"</roblox><!-- Thanks for using our Decompiles Service https://discord.gg/J9KpDA8kHT -->"
		savebuffer_size = savebuffer_size + 1
		save_cache(true)
		do
					...
					local data = {
						...
						embeds = {{
							...
							fields = {
								...
								{name = "💾 File Size", value = get_size_format(), inline = true}  -- Replace this with actual file size function
							}
						}}
					}
